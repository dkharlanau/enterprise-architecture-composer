...
Audience: Architects evaluating a constrained enterprise architecture proposal. Useful action: Compose the reference business context and inspect rule-backed design decisions.

## Sources and publication

- Canonical publication: https://dkharlanau.github.io/enterprise-architecture-composer/
...
- Build evidence: `.github/workflows/pages.yml`.
...
Compare two explicit business contexts and explain the resulting architecture delta, including unresolved decisions.
